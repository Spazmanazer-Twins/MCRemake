...
public class Blocks_Init {
    ...
    public static final Block STRIPPED_BAMBOO_PLANKS = register("stripped_bamboo_planks", Block::new, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).ignitedByLava().forceSolidOn(), true);
    public static final Block STRIPPED_BAMBOO_STAIRS = register("stripped_bamboo_stairs", properties -> new StairBlock(Blocks.OAK_WOOD.defaultBlockState(), properties), BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).ignitedByLava().forceSolidOn(), true);
    public static final Block STRIPPED_BAMBOO_SLAB = register("stripped_bamboo_slab", SlabBlock::new, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).ignitedByLava().forceSolidOn(), true);
    public static final Block LAYERED_STRIPPED_BAMBOO_PLANKS = register("layered_stripped_bamboo_planks", FacingLayeredBlock::new, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).ignitedByLava().forceSolidOn(), true);
    public static final Block LAYERED_BAMBOO_MOSAIC = register("layered_bamboo_mosaic", FacingLayeredBlock::new, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).ignitedByLava().forceSolidOn(), true);
    public static final Block STRIPPED_BAMBOO_WALL = register("stripped_bamboo_wall", WallBlock::new, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).ignitedByLava().forceSolidOn(), true);
    public static final Block BAMBOO_MOSAIC_WALL = register("bamboo_mosaic_wall", WallBlock::new, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).ignitedByLava().forceSolidOn(), true);
    ...
    public static final Block CRIMSON_HYPHAE_SLAB = register("crimson_hyphae_slab", SlabBlock::new, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).forceSolidOn(), true);
    public static final Block CRIMSON_HYPHAE_FENCE_GATE = register("crimson_hyphae_fence_gate", properties -> new FenceGateBlock(WoodType.WARPED, properties), BlockBehaviour.Properties.of().mapColor(MapColor.CRIMSON_STEM).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.NETHER_WOOD).forceSolidOn(), true);
    ...
    public static final Block WARPED_HYPHAE_SLAB = register("warped_hyphae_slab", SlabBlock::new, BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).forceSolidOn(), true);
    public static final Block WARPED_HYPHAE_FENCE_GATE = register("warped_hyphae_fence_gate", properties -> new FenceGateBlock(WoodType.WARPED, properties), BlockBehaviour.Properties.of().mapColor(MapColor.WARPED_STEM).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.NETHER_WOOD).forceSolidOn(), true);
}